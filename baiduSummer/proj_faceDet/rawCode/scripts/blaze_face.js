...
function detect(srcImgId, dstCanvasId) {
    return __awaiter(this, void 0, void 0, function () {
        var canvasDet, imgDom, imgRGBA, bboxes, imgShow, i, len, point1, point2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    canvasDet = document.getElementById(dstCanvasId);
                    imgDom = document.getElementById(srcImgId);
