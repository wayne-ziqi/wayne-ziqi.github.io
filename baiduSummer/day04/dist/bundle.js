...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "tr th,\ntr td {\n  border: 1px solid #333;\n  width: 100px;\n}\nbutton {\n  background: dodgerblue;\n  color: aliceblue;\n  border: 0;\n  width: 50px;\n  height: 30px;\n  border-radius: 10px;\n}\nbutton:hover {\n  cursor: pointer;\n}\n", ""]);
// Exports
...
document.getElementById("save").addEventListener("click", (event) => {
    controller.add(src_module);
});

document.getElementById("upload").addEventListener("click", (event) => {
    controller.upload(src_module);
});

document.getElementById("remove").addEventListener("click", (event)=>{
    controller.removeall(src_module);
});


let loadInfo = function () {
    if (localStorage)
        src_module.__value = JSON.parse(localStorage.getItem("list"));
    if (src_module.__value === null) src_module.__value = [];
    view.render(src_module.get());
}
